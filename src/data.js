...
export const data = readable({
  products: [
    ...
    },
    {
      ...
      price: "5,90€",
      season: "autumn",
      description: "Confiture extra de melon à la vanille, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
      composition: "Melon, sucre, citron, extrait de vanille",
    },
    {
      fullName: "Confiture de tomates à la vanille",
      shortName: "Tomate à la vanille",
      url: "tomate-vanille",
      imgUrl: "/confiture-tomate-vanille.jpeg",
      price: "5,50€",
      season: "autumn",
      description: "Confiture extra de tomates à la vanille, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
    ...
    },
    {
      ...
      price: "5,50€",
      season: "autumn",
      description: "Confiture extra de tomate à la vanille, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
      composition: "Tomate, sucre, citron, extrait de vanille",
    },
    {
...

    {
      ...
      price: "5,50€",
      season: "summer",
      description: "Confiture extra de figue blanche, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
    ...
    },
    {
      ...
      price: "5,50€",
      season: "summer",
      description: "Confiture extra de figue noire, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
    ...
    },
    {
      ...
      price: "5,50€",
      season: "summer",
      description: "Confiture extra de figue à la vanille, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
    ...
    },
    {
      ...
      price: "5,50€",
      season: "autumn",
      description: "Confiture extra de tomate verte, artisanale, cuite au chaudron en cuivre avec des fruits frais venant directement de producteurs locaux du Lot et Garonne.",
